...
public class SmartRacoonService extends Service {
    ...
    private static final String TAG = SmartRacoonService.class.getSimpleName();
    ...
    private Notification prepareNotification() {
        ...
        // make a stop intent
        Intent stopIntent = new Intent(this, SmartRacoonService.class);
